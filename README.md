...
- [ ] Describe Middleware?
it is code that runs before going on to the next piece of code.

- [ ] Describe a Resource?
it can be a url or something that is loaded.

- [ ] What can the API return to help clients know if a request was successful?
200 ok status code or some text that says that it is successful

- [ ] How can we partition our application into sub-applications?

using routers per url/resource
